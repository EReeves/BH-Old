...
namespace Client
{
    class DebugView
    {
        ...
        private Font debugFont = new Font(@"Content\Fonts\SourceSansPro.otf");
        ...
        public DebugView()
        {
            ...
            frameText.Position = new Vector2f(Client.Window.Size.X - 45, 0);
            frameText.CharacterSize = 16;
            frameText.Style = Text.Styles.Bold;

            fpsText.Position = new Vector2f(Client.Window.Size.X - 45, 20);
            fpsText.CharacterSize = 16;
        ...
        public void Draw()
        {
            ...
            frameText.Position = new Vector2f(frameText.Position.X + 1, frameText.Position.Y + 1);
                frameText.Draw(Client.Window, RenderStates.Default);
            ...
            fpsText.Position = new Vector2f(fpsText.Position.X + 1, fpsText.Position.Y + 1);
                fpsText.Draw(Client.Window, RenderStates.Default);
